...
const Header: React.FC<HeaderProps> = ({ isFilterResults }) => {
  ...
  return (
      <header className="max-w-screen px-10 z-30">
        <div className="max-w-screen flex justify-between items-center sm:block mx-auto mt-6 space-y-3 px-4">
          ...
          <section className="flex flex-row justify-between">
            ...
            {isAuth && isFilterResults && (
                <div className="flex items-center space-x-2">
                  <div className="relative hidden sm:flex items-center justify-around p-2 h-[60px] bg-white border border-gray-300 rounded-md shadow-md min-w-[700px]">
                    <div
